    ...
    <Document>
      <Page style={styles.page}>
        ...
        <Text style={styles.texto}>
          ...
          <View style={{ marginTop: 20 }}>
          <Text style={styles.texto}>
          <Text style={{ textDecoration: 'underline' }}>Resultado:</Text> {doc.resultado}
          </Text>
          <Text style={styles.texto}>
          Método Utilizado: ELISA V.I.H 1 y 2
          </Text>
          <Text style={styles.texto}>
          <Text style={{ textDecoration: 'underline' }}>Observaciones:</Text>
          </Text>
          <Text style={styles.texto}>
           {doc.observaciones} 
          </Text>
